class ProfitMenteWebMRenderEngine{
  ...
  static _assetDescriptor(asset){
    ...
    return {
      ...
      metadataBlobSignature:String(asset?.metadataBlobSignature||''),
      metadataBlobSize:this.finiteNumber(asset?.metadataBlobSize,0),
      metadataBlobType:String(asset?.metadataBlobType||''),
      metadataBlobLastModified:this.finiteNumber(asset?.metadataBlobLastModified,0),
