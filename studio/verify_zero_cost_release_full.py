...
def main() -> None:
    ...
    parity_checks = [
        ...
        ("QA de audio coincide con reproducción y velocidad", [node, "tests/audio-qc-playback-parity-regression.mjs"]),
        ...
        ("Captions conservan timing preview → MP4 y descartan datos corruptos", [py, "test_caption_render_timing.py"]),
        ...
        ("Render automático conserva checkpoint recuperable", [node, "tests/automation-render-checkpoint-regression.mjs"]),
