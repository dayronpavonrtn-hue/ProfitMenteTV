(()=>{
  ...
  const modules=[
    ...
    ['edit-navigation-integration.js','ProfitMenteEditNavigation'],
    ...
    ['preview-render-coordinator.js','ProfitMentePreviewRenderCoordinator'],
    ...
    ['audio-qc-engine.js','ProfitMenteAudioQCEngine'],
    ['audio-qc-integration.js','ProfitMenteAudioQC'],
    ...
    ['render-error-engine.js','ProfitMenteRenderErrorEngine'],
    ...
    ['split-edit-engine.js','ProfitMenteSplitEditEngine'],
    ['razor-all-engine.js','ProfitMenteRazorAllEngine'],
    ['razor-all-integration.js','ProfitMenteRazorAll'],
