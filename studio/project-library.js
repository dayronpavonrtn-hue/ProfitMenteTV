...
if(typeof document!=='undefined')(()=>{
  ...
  function openProject(id){const next=lib.load(id);if(!next)return;project=next;syncAll();if(typeof historyEngine!=='undefined'&&historyEngine?.seed)historyEngine.seed(project);status(`Proyecto abierto: ${project.name||'Sin título'} · autoguardado activo`)}
