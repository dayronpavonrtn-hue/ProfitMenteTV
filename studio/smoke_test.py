...
source_project={'version':'1.6','name':'Source Audio Test','mode':'Manual','duration':2,'format':'9:16','assets':[{'id':'sv','name':'source-audio.mp4','type':'video','mime':'video/mp4','duration':2}],'clips':[{'id':'svc','track':0,'name':'Video con audio original','start':0,'duration':2,'asset':'sv','sourceVolume':.75}]}
