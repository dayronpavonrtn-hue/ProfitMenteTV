...
def main() -> None:
    ...
    checks = [
        ...
        ("editor", "Herramientas manuales del generador conservan edición directa utilizable", [node, "tests/generator-manual-tools-regression.js"]),
        ...
        ("editor", "Ripple/gaps mantienen sincronizados captions palabra por palabra", [node, "tests/timeline-ripple-word-sync-regression.js"]),
        ("editor", "Extract/insert IN OUT conserva sincronía temporal y metadatos", [node, "test_range_edit.mjs"]),
        ("editor", "Lift IN OUT elimina contenido sin cerrar el hueco ni alterar duración", [node, "test_range_lift.mjs"]),
        ("editor", "Split de captions en playhead conserva tiempos y palabras sin duplicar", [node, "test_caption_split.mjs"]),
        ("editor", "Unión segura de captions preserva tiempos, texto e identidad", [node, "test_caption_merge.mjs"]),
        ...
        ("timeline", "Enfoque del rango de trabajo ajusta zoom y scroll de forma segura", [node, "test_timeline_focus.mjs"]),
        ...
        ("proyectos", "Biblioteca de proyectos persiste de forma resiliente", [node, "test_project_library.mjs"]),
        ("proyectos", "Cambio de proyecto preserva el estado activo de forma segura", [node, "test_project_switch_wiring.mjs"]),
        ("proyectos", "Proyecto activo se guarda antes de reabrir otro", [node, "test_project_reopen_flush_order.mjs"]),
        ("proyectos", "Recuperación de proyectos", [node, "test_recovery.mjs"]),
        ("proyectos", "Recuperación sigue utilizable si falla el almacenamiento del navegador", [node, "tests/recovery-storage-fallback-regression.js"]),
