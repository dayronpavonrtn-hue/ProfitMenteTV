...
function normalizeMode(value){
  if(value==null||String(value).trim()==='')return 'Automático';
  const raw=String(value).trim(),v=raw.toLowerCase();
  if(v==='automático'||v==='automatico'||v==='automatic'||v==='auto')return 'Automático';
