(()=>{
  if(typeof document==='undefined'||typeof ProfitMenteGeneratorEngine==='undefined'||typeof ProfitMenteGeneratorManualTools==='undefined')return;
  ...
  function bind(){
    ...
    if(!sceneBtn||!captionBtn||!brollBtn)return;
    sceneBtn.onclick=()=>{
